...
#define EI_CLASSIFIER_PROJECT_ID                 825137
#define EI_CLASSIFIER_PROJECT_OWNER              "Eslam_32"
#define EI_CLASSIFIER_PROJECT_NAME               "Green Box Predictive Maintenance"
...
#define EI_CLASSIFIER_FUSION_AXES_STRING         "Air temperature [K] + Process temperature [K] + Rotational speed [rpm] + Torque [Nm] + Tool wear [min] + TWF + HDF + PWF + OSF + RNF"
